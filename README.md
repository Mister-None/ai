Sigma-Telegram-AI
A decoupled, terminal-based AI assistant for Telegram. This project provides a persistent, memory-capable AI interface designed to run as a personal companion.
...
Personality-Driven: Configured with a "Stoic/Sigma" persona, providing concise, expert-level social and strategic advice. Also you can change role for whatever you wish.
...
🚀 Getting Started
Setup the Database: Ensure you have cloned "ai_data_template.db", use it for you storing history with AI.
